...
public class Uploader {
	...
	public void upload() throws Exception {
		...
		dff.setRepository(new File(ConfigProperties.getKey(ConfigList.BASIC, "IMAGE_UPLOAD_TEMP")));
		try {
			...
			List<FileItem> formList = sfu.parseRequest(this.request);
			Iterator<FileItem> iter = formList.iterator();
			while (iter.hasNext()) {
				...
				if (!fi.isFormField()) {
					...
					this.fileName = UUID.randomUUID() + this.type;					
					this.url = "http://" + ConfigProperties.getKey(ConfigList.BASIC, "OSS_IMAGE_BUCKET_NAME") + ".oss.aliyuncs.com/" + this.fileName;
					this.size = fi.getSize();
					
					
					OssOperator.putImage(this.fileName, this.contentType, this.size, fi.getInputStream());
